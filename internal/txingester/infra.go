...
type Infrastructure struct {
	...
	KafkaMonitor      kfkmntr.KafkaMonitor
...
func NewInfrastructure(cceService CCEService, kafkaMonitor kfkmntr.KafkaMonitor, txSrc string, kafkaProducer *kafka.KafkaProducer[domain.MarkedTransaction], batchProducer *kafka.KafkaBatchProducer[domain.MarkedTransaction]) *Infrastructure {
